			...
			************* -->
			<div class="main-container">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">Infirmier</li>
						<li class="breadcrumb-item active">Ajouter un/une infirmier/ére</li>
					</ol>
									...
									<div class="doctor-profile">
										...
										<div class="input-group mb-3">
											<div class="custom-file">
												...
												<label class="custom-file-label" for="changeProfile">Modifie l'mage</label>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-lg-6 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Informations infirmier/ére</div>
								</div>
								<div class="card-body">
									<div class="row gutters">
