			...
			************* -->
			<div class="main-container">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">Médecin</li>
						<li class="breadcrumb-item active">Ajouter un médecin</li>
					</ol>
						...
						<div class="col-lg-6 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Information médecins</div>
								</div>
								<div class="card-body">
									<div class="row gutters">
										...
										<div class="col-sm-12">
											<div class="text-right">
												<button class="btn btn-primary">Créer un profile</button>
											</div>
										</div>
									</div>
								</div>
